...
enum LocalizedKey: String {
    ...
    case tournamentStageLabel
    case tournamentFinalScore
...
enum LocalizedStrings {
    static let table: [LocalizedKey: [AppLanguage: String]] = [
        ...
        .gameModeTournament: [.portuguese: "Torneio", .english: "Tournament"],
        .tournamentStageLabel: [.portuguese: "Prova %d de %d", .english: "Stage %d of %d"],
        .tournamentFinalScore: [.portuguese: "Resultado final do torneio", .english: "Final tournament result"],
        .tournamentWinner: [.portuguese: "O vencedor do torneio é %@", .english: "The tournament winner is %@"],
        .tournamentTie: [.portuguese: "Empate — ninguém venceu o torneio.", .english: "It's a tie — nobody won the tournament."],
    ]
}
